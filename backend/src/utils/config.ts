...
const TEST_DB_URI: string | undefined = process.env.TEST_DB_URI;
export { PORT, DB_URI, JWT_TOP_SECRET_KEY, EMAIL_USER, EMAIL_PASS, PAGE_URL, COOKIE_TOP_SECRET_KEY, CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET, EXCHANGE_RATE_API_KEY, TEST_MP_ACCESS_TOKEN, MP_APP_ID, MP_REDIRECT_URL, TEST_DB_URI };